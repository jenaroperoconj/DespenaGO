...
import { 
  ...
  bagHandleOutline, notificationsOutline, flashOutline, restaurantOutline, scanOutline, mailOutline } from 'ionicons/icons';
...
export class HomePage implements OnInit {
  ...
  constructor(
    ...
    addIcons({mailOutline,notificationsOutline,gridOutline,bagHandleOutline,checkmarkCircleOutline,timeOutline,alertCircleOutline,warningOutline,flashOutline,homeOutline,heartOutline,restaurantOutline,scanOutline,addOutline,statsChartOutline,listOutline,refreshOutline,chevronForwardOutline});
  }
